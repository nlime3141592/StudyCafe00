...
public class SeatSelectCustomerService extends Service implements INetworkService, IConnectionService
{
	...
	public boolean tryExecuteService()
	{
		...
		if(nowTime >= endTime)
		{
			m_netModule.writeLine(NetworkLiteral.EOF);
			m_netModule.writeLine(NetworkLiteral.ERROR);
			System.out.println("SeatSelectCustomerService: Cannot access DB.");
			return false;
		}
